...
class TurnoServiceTest {
    ...
    void _1_testGuardarTurno() {
        ...
        Assertions.assertEquals("OdontologoNombre1", resultadoEsperado.getOdontologo().getNombre());
        Assertions.assertEquals("PacienteNombre1", resultadoEsperado.getPaciente().getNombre());
    }
    ...
    void _2_testBuscarTurnoPorId() throws BadRequestExceptionService {
        ...
        Assertions.assertEquals("OdontologoNombre2", resultadoEsperado2.getOdontologo().getNombre());
        Assertions.assertEquals("PacienteNombre2", resultadoEsperado2.getPaciente().getNombre());
    }
    ...
    void _5_testModificarTurno() {
        ...
        // ENTONCES
        Assertions.assertEquals(resultadoEsperado3.getFechaHora(), turnoDTO4.getFechaHora());
    }
}